...
<div th:fragment = "nav">
    <nav class="site-header sticky-top py-1">
        <div class="container d-flex flex-column flex-md-row justify-content-between">
            ...
            <h3><a class="py-2 d-none d-md-inline-block" href="/home">Home</a></h3>
            <h3><a class="py-2 d-none d-md-inline-block" href="/product">Shop</a></h3>
            <h3><a class="py-2 d-none d-md-inline-block" href="/client">Client Page</a></h3>
            <h3><a class="py-2 d-none d-md-inline-block" href="/login">Log In</a></h3>
            <h3><a class="py-2 d-none d-md-inline-block" href="/order">Cart</a></h3>
        </div>
    </nav>
</div>
