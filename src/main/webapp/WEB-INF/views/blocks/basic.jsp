...
<div th:fragment = "nav">
    <nav class="site-header sticky-top py-1">
        <div class="container d-flex flex-column flex-md-row justify-content-between">
            ...
            <h3><a class="py-2 d-none d-md-inline-block" href="#">Tour</a></h3>
            <h3><a class="py-2 d-none d-md-inline-block" href="#">Product</a></h3>
            <h3><a class="py-2 d-none d-md-inline-block" href="#">Features</a></h3>
            <h3><a class="py-2 d-none d-md-inline-block" href="#">Enterprise</a></h3>
            <h3><a class="py-2 d-none d-md-inline-block" href="#">Support</a></h3>
            <h3><a class="py-2 d-none d-md-inline-block" href="#">Pricing</a></h3>
            <h3><a class="py-2 d-none d-md-inline-block" href="#">Cart</a></h3>
        </div>
    </nav>
</div>
